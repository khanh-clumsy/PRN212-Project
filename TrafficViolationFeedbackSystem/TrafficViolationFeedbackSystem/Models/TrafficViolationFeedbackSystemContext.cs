...
public partial class TrafficViolationFeedbackSystemContext : DbContext
{
 ...
 //       => optionsBuilder.UseSqlServer("Server= QUY;uid=sa;password=123;database=TrafficViolationFeedbackSystem;Encrypt=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppealId).HasName("PK__Appeals__BB684E10DB99D52F");
        ...
        {
            entity.HasKey(e => e.AttachmentId).HasName("PK__Attachme__442C64DE20A0F184");
        ...
        {
            entity.HasKey(e => e.FineId).HasName("PK__Fines__9D4A9BCCA6FEEFB7");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E328831D67B");
        ...
        {
            entity.HasKey(e => e.ReportId).HasName("PK__Reports__D5BD48E5FAAE69EC");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC83E99B57");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105343ADEAA91").IsUnique();
        ...
        {
            entity.HasKey(e => e.VehicleId).HasName("PK__Vehicles__476B54B201202A83");

            entity.HasIndex(e => e.PlateNumber, "UQ__Vehicles__036926247EA9B08A").IsUnique();
        ...
        {
            entity.HasKey(e => e.ViolationId).HasName("PK__Violatio__18B6DC28DF7F0F8F");
        ...
        {
            entity.HasKey(e => e.ViolationTypeId).HasName("PK__Violatio__3B1A4D7D475A79A3");
